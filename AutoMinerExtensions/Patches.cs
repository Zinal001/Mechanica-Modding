...
namespace AutoMinerExtensions
{
    public class Patches
    {
        ...
        [HarmonyPatch(typeof(Game.ObjectScripts.Autominer), "Start")]
        [HarmonyPostfix()]
        public static void Patch_AutoMiner_Start(Game.FunctionalityFramework.FunctionalObject __instance)
        {
